...
para cima se a variável passo_cima estiver em True e a passo_lado False e vice-versa. Passo_cima já começa como True pois o primeiro passo do robô sempre
será para cima"""
passo_cima = True
passo_lado = False
...
while quantos_passos > 0:
  if passo_cima == True and passo_lado == False and quantos_passos >=1:
    y_final = y_final + 1
    passo_lado = True
    passo_cima = False
    quantos_passos = quantos_passos - 1
  elif passo_cima == False and passo_lado == True and quantos_passos >= 2:
    x_final = x_final + 2
    passo_lado = False
    passo_cima = True
    quantos_passos = quantos_passos - 2
  elif passo_cima == False and passo_lado == True and quantos_passos == 1:
    x_final = x_final + 1
    passo_lado = False
    passo_cima = True
    quantos_passos = quantos_passos - 1
